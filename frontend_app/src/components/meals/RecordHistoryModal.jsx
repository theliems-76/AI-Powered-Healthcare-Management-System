        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-md rounded-xl shadow-xl overflow-hidden flex flex-col max-h-[80vh]">
                <div className="p-5 border-b border-slate-200 flex justify-between items-center bg-slate-50">
                    <h2 className="text-lg font-semibold text-slate-800">Chọn Hồ Sơ Khám Bệnh</h2>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-2 bg-white">
                    {loading ? (
                        ...
                        <div className="text-center py-10 text-slate-500 text-sm">Chưa có hồ sơ khám bệnh nào.</div>
                    ) : (
                        records.map(rec => (
                            <button 
                                key={rec.id}
