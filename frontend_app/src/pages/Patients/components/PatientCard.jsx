            ...
            <div className="flex justify-between items-start mb-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs font-semibold text-slate-500 mt-0.5">{patient.phone || 'Chưa cập nhật SĐT'}</p>
                    </div>
                </div>
            ...
            <div className="mt-auto space-y-3 pt-4 border-t border-slate-100">
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-1.5 text-xs font-bold text-slate-500">
                        <Calendar className="w-3.5 h-3.5" /> Lần khám cuối:
                    </div>
                    <span className="text-xs font-bold text-slate-700">{patient.last_visit || '--'}</span>
                </div>
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-1.5 text-xs font-bold text-slate-500">
                        <Activity className="w-3.5 h-3.5" /> Rủi ro AI:
                    </div>
                    {patient.latest_risk_score !== null ? (
                        ...
                        <span className="text-[10px] font-bold text-slate-400 bg-slate-100 px-2 py-0.5 rounded-md">Chưa khám</span>
                    )}
                </div>
            </div>
        </div>
