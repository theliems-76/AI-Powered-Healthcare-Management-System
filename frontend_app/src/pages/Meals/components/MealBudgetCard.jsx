    ...
    return (
        <div className="space-y-6">
            <div className="bg-white p-6 rounded-xl border border-slate-200">
                <div className="mb-4">
                    <h2 className="font-semibold text-slate-800 text-lg">Ngân sách dinh dưỡng</h2>
                    <p className="text-xs text-slate-500">Mục tiêu hàng ngày dựa trên hồ sơ y tế</p>
                </div>
                ...
                <div className="space-y-5">
                    ...
                    <div>
                        <div className="flex justify-between text-sm mb-1">
                            <span className="font-medium text-slate-600">Năng lượng (Calo)</span>
                    ...
                    {}
                    <ProgressBar title="Tinh bột (Carbs)" current={consumed.carbs} max={dailyGoal.carbs} unit="g" colorClass="bg-blue-500" />
                    <ProgressBar title="Đạm (Protein)" current={consumed.protein} max={dailyGoal.protein} unit="g" colorClass="bg-emerald-500" />
                </div>
            </div>
