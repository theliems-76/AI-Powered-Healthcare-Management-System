            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div className="relative" ref={profileRef}>
                    <button 
                        ...
                        className="flex items-center gap-3 p-1.5 sm:pr-4 bg-transparent hover:bg-slate-50 border border-transparent hover:border-slate-200 rounded-full transition-all active:scale-95"
                    >
                        {/* Avatar */}
                    ...
                    {/* Dropdown Menu */}
                    {isProfileOpen && (
                        <div className="absolute right-0 mt-3 w-64 bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-slate-100 py-2 animate-in fade-in slide-in-from-top-2 duration-200 z-50">
                            {/* User Info */}
                            <div className="px-4 py-3 mb-2">
                                <p className="text-sm font-bold text-slate-900 truncate">{user?.full_name || 'Người dùng'}</p>
                            ...
                            <div className="px-2">
                                ...
                                >
                                    <User className="w-4 h-4 mr-3 text-slate-400" /> Hồ sơ cá nhân
                                </button>
