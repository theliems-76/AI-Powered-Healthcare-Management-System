                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between gap-4">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-semibold text-sm text-slate-600">R?i ro AI:</span>
                        </div>
    ...
    return (
        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-slate-100 transition-all hover:shadow-md group">
            <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                    <h2 className="text-xl font-bold text-slate-800">Bi?n thiên R?i ro AI (%)</h2>
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">M?c tiêu: Du?i 50%</p>
                </div>
            </div>
            ...
            <div className="flex justify-center gap-6 mt-6">
                ...
                <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-yellow-400 opacity-60"></div><span className="text-xs font-semibold text-slate-500">C?nh báo (33-66)</span></div>
                <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-rose-400 opacity-60"></div><span className="text-xs font-semibold text-slate-500">Nguy hi?m (&gt;66)</span></div>
            </div>
        </div>
    );
}
